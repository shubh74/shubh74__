...
class Property extends BaseProperty {
    ...
    constructor(propertyNode, context) {
        ...
        if (this.hasChildren) {
            this.children = Array.from(propertyNode.getElementsByTagName('property')).map((propertyNode) => new Property(propertyNode, context));
        }
    }
    /**
...
class PropertyGetResponse extends Response {
    ...
    constructor(document, context) {
        super(document, context.stackFrame.connection);
        this.children = Array.from(document.documentElement.firstChild.getElementsByTagName('property')).map((propertyNode) => new Property(propertyNode, context));
    }
}
...
class EvalResultProperty extends BaseProperty {
    constructor(propertyNode) {
        super(propertyNode);
        if (this.hasChildren) {
            this.children = Array.from(propertyNode.getElementsByTagName('property')).map((propertyNode) => new EvalResultProperty(propertyNode));
        }
    }
}
